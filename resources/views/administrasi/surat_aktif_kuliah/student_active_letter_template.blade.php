...
<body class="body-template">
    ...
    <div class="center-text">
      ...
      <p>  Nomor: <span style="color: #FFFFFF;">...... </span>/UN26.15/{{ $data->letterNumber->year ?? '' }} </p>
    </div>
    ...
    <div class="section">
        ...
        <table style="width: 100%; border-collapse: collapse">
            <tr>
                <td style="text-align: left; width: 24%">Nama</td>
    ...
    <div class="section">
        <p>
            ...
            mahasiswa di Fakultas Teknik Universitas Lampung.
        </p>
