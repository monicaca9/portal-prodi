...
@section('content')
    ...
    <div class="col-md-6">
        <div>
            <strong>Surat Keterangan Masih Kuliah dapat digunakan untuk keperluan:</strong>
            <br>a. BPJS Kesehatan Mahasiswa
            <br>b. Taspen Orang Tua
            <br>c. Tunjangan Gaji Orang Tua
        </div>
    </div>
...
@endif
                                ...
                                <td>
                                    ...
                                    <form
                                        action="{{ route('administrasi.surat_masih_kuliah.submit', ['id' => Crypt::encrypt($letter->id)]) }}"
