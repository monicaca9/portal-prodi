    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-header bg-dark">
                <h3 class="card-title"> Biodata {{$profil->nm_peran}}</h3>
            </div>
            <div class="card-body" style="margin: 0;padding: 0">
                <table class="table table-striped" style="margin: 0;padding: 0">
                    <tbody>
                        {!! tableRow('Nama Lengkap',$profil->nm_pengguna) !!}
                        {!! tableRow('Asal Prodi',$profil->nm_prodi) !!}
                        {!! tableRow('Tempat/Tanggal Lahir',($profil->tempat_lahir.', '.tglIndonesia($profil->tgl_lahir))) !!}
                        {!! tableRow('No. HP',$profil->no_tel) !!}
                    </tbody>
                </table>
            </div>
        </div>
