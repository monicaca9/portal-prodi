...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-registered"></i> Detail Ajuan Draft Penelitian- {{ $profil->nm_pd.' ('.$profil->nim.')' }}</h3>
    </div>
    <div class="card-body">
        <div class="card">
            <div class="card-header">
        ...
        <div class="card">
            <div class="card-header bg-success">
                <h3 class="card-title"><i class="fas fa-check-square"></i> Validasi Ajuan Draft Usul Penelitian</h3>
            </div>
            <form class="validasi_form" action="{{ route('validasi.pengajuan_draft_usul.update',Crypt::encrypt($ajuan->id_ver_ajuan)) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                ...
                <div class="card-footer">
                    {!! buttonBack(route('validasi.pengajuan_draft_usul')) !!}
        ...
        <script>
            $(document).ready(function() {
                $('button.tombol_validasi').on('click', function(e) {
                    ...
                    var self = $(this);
                    swal({
                        title: "Lakukan Validasi Ajuan Draft Usul Penelitan?",
