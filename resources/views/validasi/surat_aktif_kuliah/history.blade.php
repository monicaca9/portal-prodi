...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-envelope"></i> RIWAYAT PENGAJUAN SURAT AKTIF KULIAH</h3>

        </div>
        <div class="card-body">
            <form method="GET" id="filterForm" action="{{ route('validasi.surat_aktif_kuliah.history') }}">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover table-letter">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center">Tidak ada letter surat aktif kuliah.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="card-footer">
            <a href="{{ route('validasi.surat_aktif_kuliah') }}" class="btn btn-default btn-flat"><i
    ...
    @push('js')
        <script>
            ...
            document.getElementById('exportBtn').addEventListener('click', function() {
                ...
                const exportUrl = "{{ route('validasi.surat_aktif_kuliah.excel') }}";
