...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-money-check-alt"></i> Detail Ajuan RPS Peer Group - {{ $prodi->prodi }} - {{ $data->nm_mk }}</h3>
        </div>
        <div class="card-body">
            <div class="card">
...
<hr>
            ...
            <div class="card">
                ...
                <div class="card-body" style="margin: 0; padding: 0">
                    <table class="table table-striped">
                        ...
                        @if($data->status_periksa!='N'){!! tableRow('Status Ajuan','<span class="badge badge-info">'.config('mp.data_master.status_periksa.'.$data->status_periksa).' oleh '.config('mp.data_master.level_verifikasi_prodi.'.$data->level_ver).'</span>') !!}
            ...
            @if($data->status_periksa=='N')
                <div class="card">
                    ...
                    <form class="validasi_form" action="{{ route('validasi.rps_peer_group.update',Crypt::encrypt($data->id_ver_ajuan)) }}" method="POST">
                        @csrf
                        @method('PUT')
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        {!! buttonBack(route('validasi.rps_peer_group')) !!}
