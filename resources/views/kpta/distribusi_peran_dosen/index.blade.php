            ...
            <table class="table table-striped table-hover table-data">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('seminar_prodi.distribusi_peran_dosen.detail',Crypt::encrypt(['id_reg_pd'=>$each_peran_seminar->id_reg_pd,'id_jns_seminar'=>$each_peran_seminar->id_jns_seminar])) }}" class="btn btn-flat btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Detail Data"><i class="fas fa-info-circle"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
