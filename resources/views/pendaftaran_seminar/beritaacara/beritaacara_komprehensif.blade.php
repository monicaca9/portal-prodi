...
<html>
<head>
	<title>Berita Acara Seminar Komprehensif</title>
	<style type="text/css">
	@page {
   size: 21cm 29.7cm;
   margin-top: 20px;
...
<body>
	...
	Jalan Prof. Seomantri Brojonegoro No. 1 Bandar Lampung 35145 Telp.(0721)701609 ext 219, 220</span></P>
		...
		<tr >
			<td colspan="2"><hr>
			<p class="judul">
	<strong><u>BERITA ACARA SEMINAR KOMPREHENSIF</u> <br>
...
<table  width="100%">
	<tr>
		<td width="30%"align="center">Pembimbing Utama</td>
		<td width="30%"align="center">Penguji Utama,</td>
		<td width="40%" align="center">Pembimbing Pendamping</td>
...
<table border="1" cellspacing="0">
	<tr>
		...
		<td>1</td>
		<td>Teknik Penyajian</td>
		<td></td>
	</tr><tr>
		<td>2</td>
		<td>Penguasaan Substansi</td>
		<td></td>
	</tr><tr>
		<td>3</td>
		<td>Sikap Ilmiah</td>
