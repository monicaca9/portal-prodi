...
{
    protected $default_route = 'data_master.sumber_dana';
    protected $default_view = 'data_master.sumber_dana';
    protected $default_title = 'Sumber Dana';
    /**
    ...
    {
        $data = SumberDana::whereNull('expired_date')->orderBy('id_sumber_dana','ASC')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        alert()->success($this->default_title.' '.$input['nm_sumber_dana'].' berhasil ditambahkan')->persistent('OK');
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->fill($data->prepare($input));
        $data->save();
        alert()->success($this->default_title.' '.$input['nm_sumber_dana'].' berhasil diubah')->persistent('OK');
        return redirect()->route($this->default_route);
    }
    ...
    public function destroy($id)
    {
        ...
        $data = SumberDana::find($id);
        $data->drop();
        alert()->success($this->default_title.' '.$data->nm_sumber_dana.' berhasil dihapus')->persistent('OK');
