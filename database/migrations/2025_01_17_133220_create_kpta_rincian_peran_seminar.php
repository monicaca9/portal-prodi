...
return new class extends Migration
{
    ...
    {
        Schema::create('kpta.rincian_peran_seminar', function (Blueprint $table) {
            $table->uuid('id_rincian_peran_seminar')->primary();
            $table->string('judul_akt_mhs')->nullable();
    ...
    {
        Schema::dropIfExists('kpta.rincian_peran_seminar');
    }
};
