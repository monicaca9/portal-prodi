...
return new class extends Migration {
    ...
    {
        Schema::create('surat_masih.surat_masih', function (Blueprint $table) {
            ...
            $table->text('pangkat_ortu')->nullable();
            $table->text('pekerjaan_ortu')->nullable();
            $table->text('instansi_ortu')->nullable();
    ...
    {
        Schema::dropIfExists('surat_masih.surat_masih');
    }
};
